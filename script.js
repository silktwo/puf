const translations = {
  uk: {
    ...
    "route.eyebrow": "/ контакт",
    "route.title": "Залишіть контакт,\nвідповімо по суті.",
...
const routeData = {
  uk: {
    ...
    procurement: {
      ...
      copy: "Запити на каталог, прайс, партії, юридичну документацію, кодифікацію та незалежну перевірку.",
      link: "info@p-u-f.com",
      href: "mailto:info@p-u-f.com"
    },
    partnership: {
  ...
  en: {
    ...
    procurement: {
      ...
      copy: "Requests for catalog, pricing, batches, legal documents, codification, and independent review.",
      link: "info@p-u-f.com",
      href: "mailto:info@p-u-f.com"
    },
    partnership: {
